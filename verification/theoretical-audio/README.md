...
- `corrected-candidate/` is the source-scaled V1 candidate with the final 10x
  Eurorack output stage. Its normalized BP ping files are listening aids and
  must not be used as voltage evidence.
